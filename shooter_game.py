...
pygame.display.set_caption("Гра Шутер. Автор: ...")
...
text_score = font_start.render("Рахунок: " + str(score), True, (255,255,255))
text_lost = font_start.render("Пропущено: " + str(lost), True, (255,255,255))
...
for i in range(asteroids_num):
    new_asteroids = Enemy("asteroid.png", randint(10,width-70), -25, randint(3,6), (60,65))
    ...
    if not finish:
        ...
        if reload_time:
            ...
            if cur_time - last_shot_time  > 1:
                ...
                text_reload = font3.render("Зачекай іде перезарядка", True, (255,0,0))
        ...
        if score >= 10:
            ...
            window.blit(text_win, (width/2-50, height/2-50))
        ...
        if lives <=0  or lost >= 10 :
            ...
            window.blit(text_lose,(width/2-50, height/2-50))
